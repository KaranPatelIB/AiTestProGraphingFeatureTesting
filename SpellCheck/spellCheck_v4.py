...
sheet.spell("5G korrectud", "Testing1", 1, 2, 20,
            "/dicsa[][][][]sdsfdf[a]df[]asd[f][sda]f[xc]/dicsa[][][][]sdsfdf[a]df[]asd[f][sda]f[xc]/dicsa[][][][]sdsfdf[a]df[]asd[f][sda]f[xc]/dicsa[][][][]sdsfdf[a]df[]asd[f][sda]f[xc]")
sheet.spell(
    "hi to a rscheearch at Cmabrigde Uinervtisy, it deosn’t mttaer in waht oredr the ltteers in a wrod are, the olny iprmoetnt tihng is taht the frist and lsat ltteer be at the rghit pclae. The rset can be a toatl mses and you can sitll raed it wouthit porbelm. Tihs is bcuseae the huamn mnid deos not raed ervey lteter by istlef, but the wrod as a wlohe.",
